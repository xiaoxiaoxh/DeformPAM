...
class Logger:
    ...
    def _init_metadata(self):
        ...
        metadata = {
            ...
            'episode_idx': None,
            'trial_idx': None,
            'status': '',  # 'begin', 'action', 'success', 'failed'
            'action': {
                'step': None,
                'type': ''
            },
    ...
    def log_object_id(self, object_id: str):
        """log object id
        ...
        """
        assert not self._closed, AssertionError("logger closed")
        self._update_metadata('object_id', object_id)
...
if __name__ == '__main__':
    ...
    # {'path':'./log'}
    with Logger('experiment_real', r'config/experiment_logger.yaml') as logger:
        ...
        logger.log_object_id('test_object_id')
        # before fling
